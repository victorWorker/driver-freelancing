...
<head>
   ...
   <title>Buscargo test page</title>
   <!-- styles-->
      ...
      <div class="page-wrapper">
         ...
         <header class="page-header_3 mb-4 d-sm-block">
            <div id="top" class="container">
               <div class="row">
                  <div class="col-sm-4 logoholder"><img src="images/bclogo.png"></div>
                  <div class="col-sm-8 mainmenuholder d-flex flex-column mycol">
                     <div class="topmenu d-flex justify-content-end">
                        <div class="registermodal d-flex">
                           <i class="fas fa-user" aria-hidden="true"></i> 
                           <h3 class="primaryboldfont registertext uppercase"><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Registe-se</a></h3>
                        ...
                        <div class="infoblock d-flex justify-content-evenly w-50 align-items-center ms-5">
                           <div class="info1 d-flex align-items-center">
                              <i class="fas fa-phone-volume" aria-hidden="true"></i> 
                              <div>
                                 <h3 class="biginfo mb-0">210 203 206</h3>
                           ...
                           <div class="info2 d-flex align-items-center">
                              ...
                              <div>
                                 <h3 class="biginfo mb-0">info@buscargo.pt</h3>
                                 <p class="smallinfo mb-0">contact@buscargo.pt</p>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="mainmenu d-flex flex mt-4 justify-content-end align-items-center">
                        <nav>
                           <ul class="mb-0">
                              <li class="active uppercase"><a href="/" aria-current="page" class="router-link-exact-active router-link-active">Inicio</a></li>
                              <li class="uppercase"><a href="/search" class="">Pesquisar Entregas</a></li>
                              <li class="uppercase"><a href="/how-it-works" class="">Como Funciona</a></li>
                              <li class="uppercase"><a href="/help" class="">Ajuda</a></li>
                              <li class="uppercase"><a href="/aboutus" class="">Sobre Nós</a></li>
                           </ul>
                        </nav>
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal1" class="roundedborderbutton primaryboldfont uppercase">Sign In</button>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <main class="main">
            ...
            <section class="section my_sec">
               <div class="container">
                  <div class="row flex-column-reverse flex-xl-row align-items-end">
                     <div class="col-xl-6 top-50 top-xl-0">
                        <div class="promo-tabs tabs horizontal-tabs">
                           <div class="heading bottom-20">
                              <h3 class="heading__title">We save you money moving anything, anywhere</h3>
                           </div>
                           <p class="bottom-0">The UK’s favourite delivery, removals and transport marketplace</p>
                                       ...
                                       <div class="row offset-20">
                                          <div class="col-md-12">
                                             <select class="form__select" name="transport">
                                                ...
                                                <option value="value" style="background-image:url(images/sofa.png);width: 25px;">Furniture & Appliances</option>
                     ...
                     <div class="col-xl-6 text-center text-xl-left"><img class="truck-img" src="images/truck.jpg" alt="img"></div>
                  </div>
               </div>
            </section>
                  ...
                  <div class="row">
                     <div class="col-lg-6 col-xl-5">
                      <div class="video-left-part">
                        ...
                        <img class="w-100 bottom-50" src="img/section_2.jpg" alt="img">
                      </div>
                      <div class="img-badge">
                          <img class="img-badge__img" src="img/badge-img.png" alt="img">
                           <h3 class="img-badge__title bottom-0"> What they bid is  <br>what they receive</h3>
                        </div>
                     </div>
                     <div class="col-lg-6 col-xl-6 offset-xl-1">
                        <div class="heading bottom-20"><span class="heading__pre-title">About us</span>
                           <h3 class="heading__title">We don't charge <span class="color--green"> the driver</span> anything. </h3><span class="heading__layout">Charge</span>
                        </div>
                        ...
                        </ul><a class="top-40 button button--green" href="#"><span>More about</span>
                           <svg class="icon">
                              <use xlink:href="#arrow"></use>
                           </svg></a>
                        </div>
                  ...
                  <div class="row offset-50">
                     ...
                     <div class="col-sm-6 col-lg-3">
                        <div class="icon-item">
                           ...
                           <h6 class="icon-item__title">eBay Deliveries</h6>
                        </div>
                     </div>
                     <div class="col-sm-6 col-lg-3">
                        <div class="icon-item">
            ...
            <section class="section testimonials bg--lgray">
               <div class="testimonials__bg"><img class="section--bg t50 r0" src="img/testimonials-bg.png" alt="img"/></div>
               <div class="container">
                  <div class="row">
                     <div class="col-12">
            ...
            <div data-v-75fbb3d3="" class="container-fluid blackbg footer position-relative">
               <div data-v-75fbb3d3="" class="container text-white">
                  <div data-v-75fbb3d3="" class="row mt-5 pb-5">
                     <img data-v-75fbb3d3="" src="images/bclogo.png" class="yellowlogo"> 
                     <div data-v-75fbb3d3="" class="social col-sm-4 mt-5">
                        ...
                        <div data-v-75fbb3d3="" class="language d-flex align-items-center">
                           ...
                           <select data-v-75fbb3d3="" name="" id="">
                              <option data-v-75fbb3d3="" value="en">English</option>
                              <option data-v-75fbb3d3="" value="pt">Portugese</option>
                           </select>
                        </div>
                     </div>
                     ...
                     <div data-v-75fbb3d3="" class="about col-sm-4 offset-sm-1 my-3 my-sm-0">
                        ...
                        <p data-v-75fbb3d3="" class="primarylightfont"> Buscargo é uma solução completa para pedidos de transporte de itens maiores, ou qualquer item para transporte. Para os clientes, é a melhor opção não ter que ligar para muitos motoristas e solicitar um orçamento. </p>
                     </div>
                  </div>
