...
<div class="play-btn">
  ...
  <source :src="`${baseURL}images/intro-video.mp4`" type="video/mp4"></video>
        ...
        <h2  class="primaryheavyfont main-head uppercase">Buscargo Prices are upto 75% cheaper
</h2> 
<h2  class="primaryheavyfont secondarycolor main-head uppercase">Start receiving bids within minutes....</h2>
        <hr class="extrabg"> 
         
        <p class="mt-2"> We make shipping big things cheaper and easier by helping customers directly connect with suppliers who have extra space in their vehicles.
...
<label> What are you moving today</label>
    ...
    <label>  Give your job title </label>
    <input required type="text" name="title" placeholder="Job Title" id="title" v-model="form.title" />

    <input type="button" name="next" class="next action-button bg-primary uppercase" value="Next" />
  </fieldset>
  <fieldset>
<img :src="`${baseURL}images/form-img2-new.png`" class="mb-4 img-fluid" alt="">    
    ...
    />
     ...
     <label>  Drop of Point </label>
    <GmapAutocomplete
        @place_changed='setDeliveryPlace'
        :placeholder="language.delivery_location_placeholder"
    />
   
    <input type="button" name="previous" class="previous action-button bg-primary uppercase" value="Previous" />
    <input type="button" name="next" class="next action-button bg-primary uppercase" value="Next" />
  </fieldset>
  <fieldset>
<img :src="`${baseURL}images/form-img2.png`" class="mb-4 img-fluid" alt="">    
    ...
    <input type="button" name="previous" class="previous action-button bg-primary uppercase" value="Previous" />
    <input type="submit" class="action-button bg-primary uppercase" value="Submit" > 
    <div  id="show_msg"></div>
  </fieldset>
</form>
      </div>
