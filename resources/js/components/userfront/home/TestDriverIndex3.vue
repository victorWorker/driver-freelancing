...
<form id="msform" v-on:submit.prevent="submitForm">
  ...
  <!-- fieldsets -->
  <fieldset>
<img :src="`${baseURL}images/form-img1.png`" class="mb-4 img-fluid" alt="">    
...
<label>{{ language.hero_form_step1_whatareyoumoving }}</label>
  ...
  <fieldset>
<img :src="`${baseURL}images/form-img2-new.png`" class="mb-4 img-fluid" alt="">    
  ...
  <fieldset>
<img :src="`${baseURL}images/form-img2.png`" class="mb-4 img-fluid" alt="">    
...
<button type="button" class="btn btn-primary" data-bs-target="#ship1" data-bs-toggle="modal" data-bs-dismiss="modal" >Open Model</button>
      </div>
            </div>
       </div>  
                    ...
                    <div class="row">
                        ...
                        <div class="imageblock col-sm-6 col-xxl-5">
                            <img :src="`${baseURL}images/truck_driver-new.png`" class="w-100">
                              <a href="https://buscargo.pt/client/public/index.php/driver_registration" class="blackbtn formoreinfo quotebtn bg-primary uppercase"> For more info as a driver click here </a>
                        </div>
                    </div>
            </div>
        <!--Information Block-->
                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="heading heading--white">
                            <span class="heading__pre-title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Testimonies</font></font></span>
                           <h3 class="heading__title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Feedback from </font></font><span class="color--green"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">our</font></font></span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> customers</font></font></h3><span class="heading__layout layout--dgray"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">People</font></font></span>
                        </div>
                     </div>
                  </div>
                            ...
                            <div class="row">
                                <div class="headings mb-4 mb-sm-5 px-5 mt-sm-5 mt-4">
                                     <p class="mb-0">
                                       ...
                                       <p class="mb-0"> User: <span id="usr_name"></span> </p>
                                       <p> Pass: <span id="usr_pass"></span> </p>
                                   
                                         <div class="btn-continue">  <button  data-bs-target="#ship2" data-bs-toggle="modal" class="blackbtn formoreinfo quotebtn bg-primary uppercase" data-bs-dismiss="modal" >Continue</button>
                                         </div>
