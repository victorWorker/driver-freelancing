<template>
    ...
    <!-- First modal dialog -->
                        ...
                        <div class="container-fluid p-0">
                            ...
                            <div class="bigmargin mt-5 fixedbox">
                                <div class="inputingroup w-100 bg-white px-3 py-1">
                                    ...
                                    <input type="text" id="title_r" :placeholder="language.what_need_move_placeholder" v-model="form.title_r">
                                </div>
                                <div class="inputingroup w-100 bg-white px-3 py-1">
                                ...
                                <div class="d-flex justify-content-between bg-white" >
                                    <div class="inputingroup w-46 px-3 py-1" >
                                        ...
                                        <GmapAutocomplete
                                            ...
                                            :placeholder="language.collection_location_placeholder"
                                        />
                                    </div>
                                    <div class="inputingroup w-46 px-3 py-1">
                                        ...
                                        <GmapAutocomplete
                                            ...
                                            :placeholder="language.delivery_location_placeholder"
                                        />
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between bg-white" >
                                    <div class="inputingroup w-46 px-3 py-1">
                                        ...
                                        <input type="text" id="email_r" :placeholder="language.email_placeholder" :value="form.email_r">
                                    </div>
                                    <div class="inputingroup w-46 px-3 py-1">
        ...
        <!-- modal dialog -->
        <div class="modal fade" id="msgModel" aria-hidden="true" aria-labelledby="..." tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-body p-0 m-0">
                        <div class="container-fluid p-0">
                            <div class="row">
                                <div class="headings mb-4 mb-sm-5 px-5 mt-4 d-flex justify-content-between">
                                    <p>
                                        Your job is live and drivers are already looking at the job. Please continue set up to avoid missing out.

                                        Here are your login details for future refrence:
                                        User:
                                        Pass:
                                    </p>
                                </div>
                            ...
                            <button type="button" class="btn btn-primary" data-bs-target="#ship1" data-bs-toggle="modal" data-bs-dismiss="modal" >Continue</button>
...
import moment from 'moment';
    export default{
        ...
        methods:{
            ...mapActions("front",["getCategories","submitListing","uploadImg"]),
            ...
            setDeliveryPlace(place){
                ...
                if(this.form.collection != ""){
                    this.form.distance = this.getDistance(place.geometry.location, this.form.geometry.collection.location);
                }
            },
            getDistance(p1, p2) {
            ...
            submit(){
                ...
                this.submitListing(this.form).then(
                    () => {
                        ...
                        Swal.fire(
                            'Success!',
                            'Your Shipment has been Uploaded <br> Please Login to Continue',
                            'success'
                        )
                        this.modal.hide();
                    }
